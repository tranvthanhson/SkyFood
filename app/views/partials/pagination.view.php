<nav class="nav-pag">
    <ul class="pagination">
        ...
        <li><a href="/user?page=<?=($pagination['currentPage'] - 1)?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
        <?php }?>
        <!-- Lặp khoảng giữa -->
...
<!-- // Nếu là trang hiện tại thì hiển thị thẻ span
    ...
    <li><a href="/user?page=<?=($pagination['currentPage'] + 1)?>" aria-label="Next"><span aria-hidden="true">»</span></a></li>
    <?php }?>
</ul>
</nav>