                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                    ...
                                    <form data-toggle="validator" role="form" action="/post/add" method="POST" enctype="multipart/form-data">
                                        <div class="col-md-7">
                                             <div class="row">
                                                <div class="col-md-5">
                                        ...
                                        <div class="col-md-4 col-md-push-1 wrp-card">
                                            <div class="card card-user">
                                                <div class="content">
                                                    <div class="author">
                                                        <div>
                                                             <img class="avatar border-gray" src="/public/assets/img/default-avatar.png" alt="..." />
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="submit" value="them" name="them" class="btn bg-button btn-fill pull-left">
                                                 </div>
                                            </div>
                                        </form>
