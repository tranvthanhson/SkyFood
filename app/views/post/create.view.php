            ...
            <nav class="navbar navbar-default navbar-fixed">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">QL BÀI ĐĂNG</a>
                    </div>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <p class="copyright pull-right">
                        &copy; 2017 <a href="http://www.creative-tim.com">Sky Food</a> is the best.
                    </p>
                </div>
            </footer>
        </div>
...
<script src="public/assets/js/mapPost.js" type="text/javascript"></script>
