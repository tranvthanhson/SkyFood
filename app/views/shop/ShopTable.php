...
foreach ($shop as $value):
    ...
    echo '</label>
				                                            ...
				                                            <td class="control">
				                                                <div class="form-group">
				                                                    ...
				                                                    <div class="item-col">
				                                                        <a data-toggle="modal" data-target="#delshop<?=$value->SHOP_ID?>"  href="" class="btn btn-danger" title="Xoá">
    ...
    echo "view_include('partials.modal', ['id_model' => 'delshop' . $value->SHOP_ID, 'title' => 'XÓA BÀI ĐĂNG ', 'content' => 'Bạn có chắc chắn muốn xóa không??', 'bt' => 'Xóa', 'link' => '/shop/del?id=' . $value->SHOP_ID])";
