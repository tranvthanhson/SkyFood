...
class Account extends Model
{
    ...
    public function login()
    {
        if (isset($_POST['login'])) {
            ...
            $user = $this->checkUser($this->table, $username, $password)[0];
    ...
    public function updateUser()
    {
        if (isset($_POST['add'])) {
            ...
            $this->setValue($_POST['password'], $_POST['firstName'], $_POST['lastName'], $_POST['address'],
                $_POST['urlImage'], $_POST['email'], $_POST['role'], $_POST['phone']);
    ...
    public function searchUser()
    {
        if (isset($_POST['ajaxKey'])) {
            ...
            return view('admin/user/UsersTable', compact('users'));
        } else {
            $link = 'admin/user';
    ...
    public function editUserImage()
    {
        ...
        if (isset($_POST['ajaxImages'])) {
            ...
            //die($image);
            $this->setValue($account->PASSWORD, $account->FIRST_NAME, $account->LAST_NAME, $account->ADDRESS, $image, $account->EMAIL, 3, $account->PHONE);
            // die($_SESSION['user']->USERNAME);
